...
public class RandomData {
	 ...
	 * randBetween(startYear, endYear); gc.set(Calendar.YEAR, year); int
	 * dayOfYear = randBetween(1, gc.getActualMaximum(Calendar.DAY_OF_YEAR));
	 * gc.set(Calendar.DAY_OF_YEAR, dayOfYear);
	 * 
	 * String month = Integer.toString(gc.get(Calendar.MONTH)); String yearS =
	 * Integer.toString(gc.get(Calendar.YEAR)); String day = ""; Integer dayPre
	 * = gc.get(Calendar.DAY_OF_MONTH);
	 * 
	 * if (dayPre > 28) { day = "28"; } else { day = Integer.toString(dayPre); }
	 * 
